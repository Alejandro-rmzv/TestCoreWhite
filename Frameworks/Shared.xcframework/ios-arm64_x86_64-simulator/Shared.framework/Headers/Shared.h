...
- (instancetype)initWithIdCategory:(NSString *)idCategory strCategory:(NSString *)strCategory strCategoryThumb:(NSString *)strCategoryThumb strCategoryDescription:(NSString *)strCategoryDescription __attribute__((swift_name("init(idCategory:strCategory:strCategoryThumb:strCategoryDescription:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCategoryCompanion *companion __attribute__((swift_name("companion")));
- (SharedCategory *)doCopyIdCategory:(NSString *)idCategory strCategory:(NSString *)strCategory strCategoryThumb:(NSString *)strCategoryThumb strCategoryDescription:(NSString *)strCategoryDescription __attribute__((swift_name("doCopy(idCategory:strCategory:strCategoryThumb:strCategoryDescription:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *idCategory __attribute__((swift_name("idCategory")));
@property (readonly) NSString *strCategory __attribute__((swift_name("strCategory")));
@property (readonly) NSString *strCategoryDescription __attribute__((swift_name("strCategoryDescription")));
@property (readonly) NSString *strCategoryThumb __attribute__((swift_name("strCategoryThumb")));
@end
...
@interface SharedIngredient : SharedBase
- (instancetype)initWithIdIngredient:(NSString * _Nullable)idIngredient strIngredient:(NSString *)strIngredient strDescription:(NSString * _Nullable)strDescription __attribute__((swift_name("init(idIngredient:strIngredient:strDescription:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedIngredientCompanion *companion __attribute__((swift_name("companion")));
- (SharedIngredient *)doCopyIdIngredient:(NSString * _Nullable)idIngredient strIngredient:(NSString *)strIngredient strDescription:(NSString * _Nullable)strDescription __attribute__((swift_name("doCopy(idIngredient:strIngredient:strDescription:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable idIngredient __attribute__((swift_name("idIngredient")));
@property (readonly) NSString * _Nullable strDescription __attribute__((swift_name("strDescription")));
@property (readonly) NSString *strIngredient __attribute__((swift_name("strIngredient")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Ingredient.Companion")))
@interface SharedIngredientCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedIngredientCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithIdMeal:(NSString *)idMeal strMeal:(NSString *)strMeal strCategory:(NSString * _Nullable)strCategory strInstructions:(NSString * _Nullable)strInstructions strMealThumb:(NSString * _Nullable)strMealThumb strArea:(NSString * _Nullable)strArea __attribute__((swift_name("init(idMeal:strMeal:strCategory:strInstructions:strMealThumb:strArea:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMealCompanion *companion __attribute__((swift_name("companion")));
- (SharedMeal *)doCopyIdMeal:(NSString *)idMeal strMeal:(NSString *)strMeal strCategory:(NSString * _Nullable)strCategory strInstructions:(NSString * _Nullable)strInstructions strMealThumb:(NSString * _Nullable)strMealThumb strArea:(NSString * _Nullable)strArea __attribute__((swift_name("doCopy(idMeal:strMeal:strCategory:strInstructions:strMealThumb:strArea:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *idMeal __attribute__((swift_name("idMeal")));
@property (readonly) NSString * _Nullable strArea __attribute__((swift_name("strArea")));
@property (readonly) NSString * _Nullable strCategory __attribute__((swift_name("strCategory")));
@property (readonly) NSString * _Nullable strInstructions __attribute__((swift_name("strInstructions")));
@property (readonly) NSString *strMeal __attribute__((swift_name("strMeal")));
@property (readonly) NSString * _Nullable strMealThumb __attribute__((swift_name("strMealThumb")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Meal.Companion")))
@interface SharedMealCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMealCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("MealsRepository")))
@protocol SharedMealsRepository
@required
...
*/
- (void)getCategoriesWithCompletionHandler:(void (^)(NSArray<SharedCategory *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCategories(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getMealDetailId:(NSString *)id completionHandler:(void (^)(SharedMeal * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getMealDetail(id:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)searchMealsKeyword:(NSString *)keyword completionHandler:(void (^)(NSArray<SharedMeal *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("searchMeals(keyword:completionHandler:)")));
@end
...
- (NSString *)lookupMealId:(NSString *)id __attribute__((swift_name("lookupMeal(id:)")));
- (NSString *)searchMealsKeyword:(NSString *)keyword __attribute__((swift_name("searchMeals(keyword:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPath:(NSString *)path query:(NSDictionary<NSString *, NSString *> *)query headers:(NSDictionary<NSString *, NSString *> *)headers deserializer:(id<SharedKotlinx_serialization_coreKSerializer>)deserializer completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("get(path:query:headers:deserializer:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getJsonPath:(NSString *)path query:(NSDictionary<NSString *, NSString *> *)query headers:(NSDictionary<NSString *, NSString *> *)headers completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getJson(path:query:headers:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorNetworkClient")))
@interface SharedKtorNetworkClient : SharedBase <SharedNetworkClient>
- (instancetype)initWithConfig:(SharedNetworkConfig *)config __attribute__((swift_name("init(config:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithBaseUrl:(NSString *)baseUrl defaultHeaders:(NSDictionary<NSString *, NSString *> *)defaultHeaders timeout:(SharedTimeoutConfig *)timeout enableLogging:(BOOL)enableLogging dynamicHeadersProvider:(id<SharedKotlinSuspendFunction0> _Nullable)dynamicHeadersProvider __attribute__((swift_name("init(baseUrl:defaultHeaders:timeout:enableLogging:dynamicHeadersProvider:)"))) __attribute__((objc_designated_initializer));
- (SharedNetworkConfig *)doCopyBaseUrl:(NSString *)baseUrl defaultHeaders:(NSDictionary<NSString *, NSString *> *)defaultHeaders timeout:(SharedTimeoutConfig *)timeout enableLogging:(BOOL)enableLogging dynamicHeadersProvider:(id<SharedKotlinSuspendFunction0> _Nullable)dynamicHeadersProvider __attribute__((swift_name("doCopy(baseUrl:defaultHeaders:timeout:enableLogging:dynamicHeadersProvider:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *baseUrl __attribute__((swift_name("baseUrl")));
@property (readonly) NSDictionary<NSString *, NSString *> *defaultHeaders __attribute__((swift_name("defaultHeaders")));
@property (readonly) id<SharedKotlinSuspendFunction0> _Nullable dynamicHeadersProvider __attribute__((swift_name("dynamicHeadersProvider")));
@property (readonly) BOOL enableLogging __attribute__((swift_name("enableLogging")));
@property (readonly) SharedTimeoutConfig *timeout __attribute__((swift_name("timeout")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TimeoutConfig")))
@interface SharedTimeoutConfig : SharedBase
- (instancetype)initWithConnectTimeoutMillis:(int64_t)connectTimeoutMillis requestTimeoutMillis:(int64_t)requestTimeoutMillis socketTimeoutMillis:(int64_t)socketTimeoutMillis __attribute__((swift_name("init(connectTimeoutMillis:requestTimeoutMillis:socketTimeoutMillis:)"))) __attribute__((objc_designated_initializer));
- (SharedTimeoutConfig *)doCopyConnectTimeoutMillis:(int64_t)connectTimeoutMillis requestTimeoutMillis:(int64_t)requestTimeoutMillis socketTimeoutMillis:(int64_t)socketTimeoutMillis __attribute__((swift_name("doCopy(connectTimeoutMillis:requestTimeoutMillis:socketTimeoutMillis:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedHttpClientFactory_iosKt : SharedBase
+ (SharedKtor_client_coreHttpClient *)createHttpClientConfig:(SharedNetworkConfig *)config __attribute__((swift_name("createHttpClient(config:)")));
@end
